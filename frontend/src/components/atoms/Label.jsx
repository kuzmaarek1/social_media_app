      ...
      className={`absolute w-30% left-0 ${styles} pl-4 duration-300 transform 
        ...
        ${
          form
            ...
            : 'peer-valid:translate-x-[3%] peer-valid:translate-y-[-110%] peer-valid:text-[0.65rem] peer-valid:tracking-wider peer-valid:bg-input peer-valid:rounded peer-valid:pl-2 peer-valid:pr-2'
        }`}
    >
      {placeholder}
    </label>
